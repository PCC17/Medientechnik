<?php
    require("backSites/loggedIn.php");
?>
<!doctype html>
<html class="no-js" lang="">
    ...
    <h1>Table</h1>
    <hr>
    <form class="form-inline" method="post" action="backSites/logout.php">
  <button type="submit" class="btn btn-primary">Logout</button>
</form>
<hr>

    <div><span id="successMsg" style="background-color:green;" hidden = true>Erfolgreich</span></div>
